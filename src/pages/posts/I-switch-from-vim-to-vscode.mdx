...
## Why Vim?
So long as I know only a small percent of developers pick up Vim as main IDE, a fair amout of people don't even know how to exit it, these makes those who master Vim looks cool, every action is handled by typing, mouse becomes useless, besides Vim makes its user looks "cool", there are also other benefits.
...
JS/TS is the main programming language in my current team, vscode naturally supports those languages too well that I don't really need to commit much time to research how to make vscode good enough for my day-to-day work.
another feature that Vim doesn't do well is debugging, step into/out and view real-time variable values sometimes is efficient, Vim can do with the help of some plugins but not that well compare with most GUI based IDEs.
